...
TEST(DoubleLinkedListTest, IsEmptyOnCreate) {
  MY_DS::DoubleLinkedList<int> list;
...
TEST(DoubleLinkedListTest, PushBackFront){
  MY_DS::DoubleLinkedList<int> list;
  ...
  MY_DS::DoubleLinkedList<int> list2;
...
TEST(DoubleLinkedListTest, Clear){
  ...
  MY_DS::DoubleLinkedList<int> empty_list;
  EXPECT_EQ(list.size(), 0);
  list.clear();
  EXPECT_EQ(list.size(), 0);
}
